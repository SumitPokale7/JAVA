...
// These methods are sometimes referred to as subclass's responsibility because
...
// Abstract classes can include as much implementation as they see fit i.e.there
// can be concrete methods(methods with body)
// in abstract class.

// Although abstract classes cannot be used to instantiate objects, they can be
// used to create object references,
// because Java’s approach to run-time polymorphism is implemented through the
// use of superclass references.

// A public constructor on an abstract class doesn't make any sense because you
// can't instantiate an abstract class directly
// (can only instantiate through a derived type that itself is not marked as
// abstract)
// Check:
...
// subclass to have any meaning.
// In this case, you want some way to ensure that a subclass does, indeed,
// override all necessary methods. Java’s solution
