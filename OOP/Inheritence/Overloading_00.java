...
// alone is insufficient to distinguish two
// versions of a method. When Java encounters a call to an overloaded method, it
...
// integer argument inside Overload, no matching method is found. However, Java
// can automatically convert an integer
...
// and a reference to it is returned to the
// calling routine. Since all objects are dynamically allocated using new, you
// don’t need to worry about an object going
// out-of-scope because the method in which it was created terminates. The
// object will continue to exist as long as there
// is a reference to it somewhere in your program. When there are no references
// to it, the object will be reclaimed the
