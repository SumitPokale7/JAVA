...
// ********************************************************************************************************************************************************************
// A Class is a name of Group Properties & Function

//  Constructor
//  Constructor is a Special function, that Runs when you Create Object
...
class Student {
    ...
    Student() {
        ...
        this(13, "Sumit", 100.0f); // --> Internally, new Student();
    }
