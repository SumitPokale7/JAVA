...
// Packages are containers for classes. They are used to keep the class name
// space compartmentalized.
// For example, a package allows you to create a class named List, which you can
// store in your own package without
// concern that it will collide with some other class named List stored
// elsewhere. Packages are stored in a hierarchical
// manner and are explicitly imported into new class definitions.

// The package is both a naming and a visibility control mechanism.

// The following statement creates a package called MyPackage: package
// MyPackage;

// Java uses file system directories to store packages. For example, the .class
// files for any classes you declare to be
...
// choose your package names carefully.
// You cannot rename a package without renaming the directory in which the
// classes are stored.
...
// Thus, if your package is in a subdirectory of the current directory, it will
// be found.
...
// public will be available to non-subclasses
